...
class BBKDataset:
    def __init__(self, zone: tuple = ("alles",), split: str = "train", random_seed = 1,
        ...
        self.BBK_CLASSES_list = ["null","wooded_area", "water", "bushes", "individual_tree", 
        ...
        # Noise percent
        percent_noise = 0.1
        # Noise std for R-G-B-IR channels
        self.noise_std = self.std_vals_tiles[:4].squeeze()*percent_noise
